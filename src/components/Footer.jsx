      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="pt-10 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            {/* Instagram */}
            <a
              href="https://www.instagram.com/city_fashion_maddur?igsh=MTBrbHJ4cTIydDJlNg%3D%3D&utm_source=qr"
              target="_blank"
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/share/1CbNkj8E9B/?mibextid=wwXIfr"
              target="_blank"
              rel="noopener noreferrer"
              className="w-5 h-5 text-gray-500 hover:text-white transition-colors"
              aria-label="Facebook"
